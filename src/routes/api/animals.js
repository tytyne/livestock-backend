...
router.get("/:farmId/earring",checkAuthorisation,animalController.getAnimalEaring)
router.get("/:farmId/check/all",checkAuthorisation,animalController.getAnimals)
router.put("/:farmId/:id",checkAuthorisation,animalController.updateAnimal)
router.delete("/:farmId/:id",checkAuthorisation,animalController.deleteAnimal)
