...
router.get("/farm/transactions/:id/pl",checkAuthorisation,farmReport.IncomeExpenseReports)
router.get("/farm/transactions/:id",checkAuthorisation,farmReport.farmTransactions)
