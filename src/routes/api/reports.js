...
router.get("/farm/:id/cash_flow",checkAuthorisation,farmReport.CashflowReports)
router.get("/farm/:id/pl",checkAuthorisation,farmReport.PLReports)
...
router.get("/livestock/upcoming_treatments",checkAuthorisation,TreatmentReport.getUpcommingTreatments)
